  ...
  return (
    <div id="Contact" className="bg-primary py-5">
      <div className="container">
        <div className="grid gap-4 blade-padding-lg">
          <h2 className="text-blue text-center">Ready to build something</h2>
          <h5 className="text-blue text-center">Leave a message for me!</h5>
        ...
        <h6 className="pt-10 text-right font-light">developed by @VED</h6>
      </div>
    </div>
  );
}
